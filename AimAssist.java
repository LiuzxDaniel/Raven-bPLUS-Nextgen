...
public class AimAssist extends Module {
   ...
   public AimAssist() {
      ...
      this.registerSetting(distance = new DoubleSliderSetting("Max Distance", 0, 3, 0, 6, 0.5));
   ...
   public Entity getEnemy() {
      ...
      do {
         do {
            ...
            } while ((double) mc.thePlayer.getDistanceToEntity(en) > distance.getInputMax()
                  || (double) mc.thePlayer.getDistanceToEntity(en) < distance.getInputMin());
